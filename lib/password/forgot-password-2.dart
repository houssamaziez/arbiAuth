import 'package:arbiauth/password/forgot-password-3.dart';
...
class Forgotpassword2 extends StatelessWidget {
  ...
  Forgotpassword2({super.key, required this.phone});
  @override
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Text(
                          'If you did not receive an identify code. Enter \' Resend ‘. Check  your phone no. $phone',
                          style: SafeGoogleFont(
                            'Poppins',
                            fontSize: 14 * ffem,
                      ...
                      Container(
                          ...
                          child: TextField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintText:
                                  'Identify code', // Optional placeholder text
                            ),
                          )),
                      Align(
